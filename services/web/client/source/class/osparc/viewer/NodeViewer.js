...
qx.Class.define("osparc.viewer.NodeViewer", {
  ...
  members: {
    ...
    __retrieveInputs: function() {
      ...
      if (srvUrl) {
        const urlUpdate = this.isDynamicV2() ? osparc.utils.Utils.computeServiceV2RetrieveUrl(this.getStudyId(), this.getNodeId()) : osparc.utils.Utils.computeServiceRetrieveUrl(srvUrl);
